...
const dict: Record<Lang, Record<string, string>> = {
  tr: {
    ...
    performance_title: 'Personel Performansı',
    total_performance: 'Toplam Performans',
    orders: 'sipariş',
    sales_chart_title: 'Saatlik Satış',
    daily_sales: 'Günlük Satışlar',
    no_data: 'Veri bulunamadı',
    product_sales_title: 'Ürün Bazlı Satışlar',
  ...
  en: {
    ...
    orders: 'orders',
    sales_chart_title: 'Hourly Sales',
    daily_sales: 'Daily Sales',
    no_data: 'No data found',
    product_sales_title: 'Product Sales',
