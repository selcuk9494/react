...
const dict: Record<Lang, Record<string, string>> = {
  tr: {
    ...
    amount_above: 'Üstü',
    amount_below: 'Altı',
    amount_placeholder: 'Örn: 500',
    matching_transactions: 'adet işlem',
    matching_total: 'Toplam',
    ...
    cash_report_desc: 'Kasa bazlı satış özeti',
    cash_no: 'Kasa No',
  ...
  en: {
    ...
    cash_report_desc: 'Register-based sales summary',
    cash_no: 'Cash No',
